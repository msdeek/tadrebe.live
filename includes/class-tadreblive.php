...
class tadreblive {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('init', $plugin_cpanel_admin, 'register_bbb_settings');
		...
		$this->loader->add_filter('manage_edit-sfwd-topic_columns', $plugin_cpanel_admin,'cpanel_module_id_columns');
		$this->loader->add_action('manage_sfwd-topic_posts_custom_column', $plugin_cpanel_admin,'cpanel_module_id_column', 10, 2);
